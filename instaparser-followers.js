...
div.innerHTML = '<div class="insta-wrapper"><div class="insta-modal-wrap"><div class="insta-modal"><div class="insta-header"><div class="insta-title">instaParser <span>сбор подписчиков и подписок</span></div><div class="insta-close j-insta-close"><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.12138 0.292893C1.73086 -0.0976311 1.09769 -0.0976311 0.707168 0.292893C0.316644 0.683417 0.316644 1.31658 0.707168 1.70711L11.5416 12.5416L0.292893 23.7903C-0.0976311 24.1809 -0.0976311 24.814 0.292893 25.2046C0.683418 25.5951 1.31658 25.5951 1.70711 25.2046L12.9559 13.9558L24.0417 25.0416C24.4322 25.4322 25.0654 25.4322 25.4559 25.0416C25.8464 24.6511 25.8464 24.0179 25.4559 23.6274L14.3701 12.5416L25.0416 1.87003C25.4322 1.4795 25.4322 0.846339 25.0416 0.455815C24.6511 0.0652907 24.0179 0.0652907 23.6274 0.455815L12.9559 11.1274L2.12138 0.292893Z" fill="#F5F5F5"/></svg></div></div><div class="insta-section"><div class="insta-col"><div class="insta-col-content">Внимание: во избежание блокировки - старайтесь не использовать личный аккаунт для сбора данных и не превышайте лимиты Instagram. Сбор данных осуществляется только с открытого аккаунта, либо вы должны быть на него подписаны.</div></div></div><div class="insta-section"><div class="insta-row insta-start"><div class="insta-col divider"><div class="insta-col-content"><div class="insta-account"><div class="insta-account-image"><img class="j-account-image"><div class="insta-insta-back"></div><div class="insta-black-back"></div></div><div class="insta-account-data"><div class="insta-account-name j-account-name">Имя аккаунта</div><div class="insta-account-id">ID аккаунта: <span class="j-account-id">0</span></div><div class="insta-account-private j-account-private">Доступность</div><div class="insta-account-followers">Подписчики: <span class="j-account-followers">0</span></div><div class="insta-account-following">Подписки: <span class="j-account-following">0</span></div><div class="insta-account-posts">Публикации: <span class="j-account-posts">0</span></div></div></div></div></div><div class="insta-col divider"><div class="insta-col-content"><div class="insta-col-name">Сбор данных:</div><div class="insta-radio-group"><div class="insta-radio"><input form="instaParseForm" id="radio-one" type="radio" name="instaRadioParse" class="j-radio-followers" value="followers" checked> <label for="radio-one"><div>Подписчики</div><span>Сбор подписчиков</span></label></div><div class="insta-radio"><input form="instaParseForm" id="radio-two" type="radio" name="instaRadioParse" class="j-radio-following" value="following"> <label for="radio-two"><div>Подписки</div><span>Сбор подписок</span></label></div></div><div class="insta-star">при переключении будет сброшен текущий сбор и файл данных</div></div></div><div class="insta-col divider"><div class="insta-col-content"><div class="insta-col-name">Формат данных:</div><div class="insta-radio-group"><div class="insta-radio"><input form="instaSaveForm" id="radio-three" type="radio" name="instaRadioFormat" class="j-radio-json" value="json" checked> <label for="radio-three"><div>Формат JSON</div><span>Данные в формате JSON</span></label></div><div class="insta-radio"><input form="instaSaveForm" id="radio-four" type="radio" name="instaRadioFormat" class="j-radio-excel" value="csv"> <label for="radio-four"><div>Формат Excel (CSV)</div><span>Данные в формате CSV</span></label></div></div><div class="insta-star">переключать формат и скачивать данные, можно в любой момент</div></div></div></div></div><div class="insta-section"><div class="insta-row"><div class="insta-col"><div class="insta-col-content"><div class="insta-col-name">Ограничение кол-ва запросов</div><div class="insta-col-desc">Лимиты Instagram: в сутки не более 150-500 запросов на сбор данных (это примерно 15-50К аккаунтов). Чтобы полностью убрать ограничение парсера - очистите значение в поле или поставьте 0.</div></div></div><div class="insta-col insta-left"><div class="insta-request"><input form="instaParseForm" type="number" class="j-request-count" name="instaRequestCount" value="150"></div></div></div></div><div class="insta-section"><div class="insta-row"><div class="insta-col"><div class="insta-col-content"><div class="insta-col-name">Имитация человека</div><div class="insta-col-desc">Отправка запросов с разными интервалами (1-8 сек). По умолчанию запросы отправляюся без задержек. Включите, чтобы уменьшить риск блокировки, но время сбора данных увеличится.</div></div></div><div class="insta-col insta-left"><div class="insta-checkbox"><input form="instaParseForm" type="checkbox" name="instaImitation" id="insta-imitation" class="j-insta-imitation"> <label for="insta-imitation"></label></div></div></div></div><div class="insta-section"><div class="insta-row insta-center"><div class="insta-col"><div class="insta-col-content"><div class="insta-col-name">Точка остановки</div><div class="insta-col-desc">Данный код служит отметкой кол-ва собранных аккаунтов. Чтобы продолжить сбор с места прерывания - сохраните код. Код служит, чтобы продолжить сбор минуя кол-во уже собранных аккаунтов.</div><div class="insta-endpoint"><input form="instaParseForm" type="text" name="instaEndPoint" class="j-endpoint-code" value=""> <a class="insta-btn j-copy-btn">Скопировать</a></div></div></div><div class="insta-col"><div class="insta-start-wrapper"><form id="instaParseForm"><button form="instaParseForm" class="insta-start-emitter j-insta-start">Старт</button></form><div class="insta-start-wave"></div></div></div></div></div><div class="insta-section"><div class="insta-row insta-center"><div class="insta-col"><div class="insta-col-content"><ul class="insta-console"><li>Кол-во запросов:<span class="j-request-total">0</span></li><li>Собрали аккаунтов:<span class="j-accounts-total">0</span></li><li>Время сбора:<span class="j-time-total">00:00:00</span></li></ul></div></div><div class="insta-col"><form id="instaSaveForm"><a class="insta-btn j-download-btn">Скачать данные</a></form></div></div></div><div class="insta-section"><div class="insta-row"><div class="insta-col"><ul class="insta-footer"><li><a class="pay-coffee" href="https://pay.mysbertips.ru/72317565" target="_blank"><svg viewBox="0 0 46 62" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40.2373 10.5203H43.9509C45.0431 10.5203 45.48 9.85609 45.48 8.74908V7.64207C45.48 6.75646 44.8246 5.87085 43.7324 5.87085H40.2373H5.94115H2.22755C1.35377 5.87085 0.47998 6.53506 0.47998 7.64207V8.74908C0.47998 9.63469 1.35377 10.5203 2.22755 10.5203H5.94115H40.2373Z" fill="#F5F5F5"/><path d="M5.94115 5.87085H40.2373C40.2373 3.21402 38.0528 1 35.4314 1H10.747C8.12561 1 5.94115 3.21402 5.94115 5.87085Z" fill="#F5F5F5"/><path d="M40.2373 10.5203H5.94115L6.81493 21.1476H39.3635L40.2373 10.5203Z" fill="#F5F5F5"/><path d="M36.0868 59.0074L37.179 46.8303H8.9994L10